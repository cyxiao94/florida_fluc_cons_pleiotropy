    ...
    for(j in 1:NB_trials){
      ...
      ne <- rbind(ne, data.frame(trial = j,
                                 ne = estimateNe(p0 = mat_af[ind, i], pt = mat_af[ind, i+5], 
                                                 ...
                                                 t = 160, ploidy=2, truncAF=0.05, method=c("P.planI"), 
...
permu_cmh_test <- function(pop_af, pop_cov){
  ...
  pop_cmh_auto<-adapted.cmh.test(freq = pop_af_auto, 
                                 ...
                                 Ne = pop_ne_auto, order=1, gen = c(0,160), repl = 1:5, poolSize = rep(600,10))
  ##X
...
freqf<-readRDS("Anc_ConsF160_FlucF160_AF.rds")
covf<-readRDS("Anc_ConsF160_FlucF160_COV.rds")
...
dt_combined[, `:=`(
  AFC_Cons_R1 = Cons_F160.R1.freq-Anc_F0.R1.freq,
  AFC_Cons_R2 = Cons_F160.R2.freq-Anc_F0.R2.freq,
  AFC_Cons_R3 = Cons_F160.R3.freq-Anc_F0.R3.freq,
  AFC_Cons_R4 = Cons_F160.R4.freq-Anc_F0.R4.freq,
  AFC_Cons_R5 = Cons_F160.R5.freq-Anc_F0.R5.freq,
  AFC_Fluc_R1 = Fluc_F160.R1.freq-Anc_F0.R1.freq,
  AFC_Fluc_R2 = Fluc_F160.R2.freq-Anc_F0.R2.freq,
  AFC_Fluc_R3 = Fluc_F160.R3.freq-Anc_F0.R3.freq,
  AFC_Fluc_R4 = Fluc_F160.R4.freq-Anc_F0.R4.freq,
  AFC_Fluc_R5 = Fluc_F160.R5.freq-Anc_F0.R5.freq
)]
