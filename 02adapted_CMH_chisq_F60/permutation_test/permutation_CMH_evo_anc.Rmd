...
colnames(freqf)<-c("Anc_F0.R1.freq","Cons_F60.R1.freq","Fluc_F60.R1.freq",
                   "Anc_F0.R2.freq","Cons_F60.R2.freq","Fluc_F60.R2.freq",
                   "Anc_F0.R3.freq","Cons_F60.R3.freq","Fluc_F60.R3.freq",
                   "Anc_F0.R4.freq","Cons_F60.R4.freq","Fluc_F60.R4.freq",
                   "Anc_F0.R5.freq","Cons_F60.R5.freq","Fluc_F60.R5.freq")
covf <- coverage(sync_file, gen = c(0,60,260), repl = 1:5)
colnames(covf)<-c("Anc_F0.R1.freq","Cons_F60.R1.freq","Fluc_F60.R1.freq",
                  "Anc_F0.R2.freq","Cons_F60.R2.freq","Fluc_F60.R2.freq",
                  "Anc_F0.R3.freq","Cons_F60.R3.freq","Fluc_F60.R3.freq",
                  "Anc_F0.R4.freq","Cons_F60.R4.freq","Fluc_F60.R4.freq",
                  "Anc_F0.R5.freq","Cons_F60.R5.freq","Fluc_F60.R5.freq")
...
saveRDS(freqf, file = "Anc_ConsF60_FlucF60_AF.rds")
saveRDS(covf, file = "Anc_ConsF60_FlucF60_COV.rds")
...
#from empirical data
##103053+11967 significant in the constant
##11967+77498 significant in the fluctuating
per_share_obs <- 11967/(103053+11967+77483)
p_value <- (sum(perm_result$Permutation<per_share_obs)+1)/1001
```
