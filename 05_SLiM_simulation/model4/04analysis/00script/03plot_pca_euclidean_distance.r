...
for (num_snp in c("10000")){
  for (pleio in c("pleio")){
    for (set in seq(1,100)){
      ...
      saveRDS(pca.res$x,file=paste0("plot_pca_new/",num_snp,"targets_",pleio,"_set",set,"_loadings.rds"))
      saveRDS(pca.var,file=paste0("plot_pca_new/",num_snp,"targets_",pleio,"_set",set,"_var.rds"))
    ...
    ggsave(paste0("plot_pca_new/",num_snp,"targets_",pleio,"_set",set,".pdf"),plot=p1)
