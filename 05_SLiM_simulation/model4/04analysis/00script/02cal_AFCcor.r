...
cal_afc=function(num_snp,pleio,set){
  ##load af
      rep1=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p1.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r1=rep1[,3]-rep1[,2];
      rep2=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p2.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r2=rep2[,3]-rep2[,2]
      rep3=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p3.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r3=rep3[,3]-rep3[,2]
      rep4=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p4.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r4=rep4[,3]-rep4[,2]
      rep5=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p5.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r5=rep5[,3]-rep5[,2]
      rep6=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p6.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r6=rep6[,3]-rep6[,2]
      rep7=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p7.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r7=rep7[,3]-rep7[,2]
      rep8=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p8.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r8=rep8[,3]-rep8[,2]
      rep9=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p9.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r9=rep9[,3]-rep9[,2]
      rep10=fread(paste0("../03results/03results_",num_snp,"SNP_",pleio,"_set",set,"_p10.freq.gz"), select=c("Pos","F0.freq","F60.freq"));afc_r10=rep10[,3]-rep10[,2]
...
for (num_snp1 in c(10000)){
    for (pleio1 in c("pleio")){
        for (set1 in 1:100){
            ...
            cmh=fread(paste0('cmh_result/',num_snp1,'_',pleio1,'_set',set1,'.cmh'))
